...
class DatePicker extends HTMLElement {
  format = "DD MMM' YYY DDDD";
  // format = `<h1 style="font-size:35px;margin-left:-10px">DD <span style="font-size: 20px">MMM' YYY</span></h1>
  //           <p style="font-size:17px;font-weight:100;margin-top:-22px;margin-left:-60px">DDDD</p>`;
  position = "bottom";
  visible = false;
  date = null;
  mounted = false;
